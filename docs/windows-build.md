...
straight out of audio files. It is required: every package build ships
it, and the configure step stops without it.
...
```powershell
vcpkg install zlib:x64-windows taglib:x64-windows
